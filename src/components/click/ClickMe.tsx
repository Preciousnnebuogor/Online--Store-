    ...
    <>
      <div className={style.text}>
        <h1>
          ...
          Trendsetting Men Fashion!
        </h1>
        <p>
          {`At Perfection Online Store, we understand that fashion is an
          expression of individuality and personality. That is why we curate a
          diverse collection of men wears that cater to every style, occasion,
        ...
        <p>
          {`Our extensive range of men clothing covers a spectrum of styles,
          ensuring that you are always dressed to impress. Whether you are looking
        ...
        <p>
          ...
          stand the test of time, our selection ensures that you are always in
      ...
      <div className={style.img}>
        ...
        <div className={style.para}>
          <p>
            {`We have made fashioning for our classic men more easy,reliable and
            cost effective making your shopping online fast and reliable. As a
            result payment can be made on delivery to any location of your
            choice. Perfection your NO 1 Shopping App. We have made fashioning
            for our classic men more easy,reliable and cost effective making
            your shopping online fast and reliable.`}
          </p>
        </div>
      </div>
    </>
